                            ...
                            {selectedRace.horses &&
                              selectedRace.horses.map((horse, j) => (
                                ...
                                >
                                  ...
                                  <td className="p-3">
                                    <div
                                      className="font-semibold text-gray-700 text-sm truncate max-w-37.5"
                                      title={horse.owner}
                                    >
                                      {horse.owner}
                                    </div>
                                    <div
                                      className="text-xs text-gray-500 font-medium mt-0.5 truncate max-w-37.5"
                                      title={horse.trainer}
                                    >
                                      {horse.trainer}
                                    </div>
                                  ...
                                  <td className="p-3">
                                    <div
                                      className="text-xs text-gray-500 max-w-45 truncate whitespace-normal"
    ...
    <div className="min-h-screen bg-gray-50 text-left font-sans py-8">
      ...
      {updateInfo && updateInfo.updateAvailable && !updateDismissed && (
        <div className="fixed top-0 left-0 right-0 z-50 animate-in fade-in slide-in-from-top-4 duration-500">
          <div className="bg-linear-to-r from-emerald-600 to-teal-600 text-white px-6 py-3 flex items-center justify-center gap-4 shadow-lg">
            <div className="flex items-center gap-2">
              <svg
      ...
      {updateInfo &&
        ...
        updateInfo.message.includes("başarılı") && (
          <div className="fixed top-0 left-0 right-0 z-50 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="bg-linear-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 flex items-center justify-center gap-4 shadow-lg">
              <div className="flex items-center gap-2">
                <svg
                  className="w-5 h-5"
                  fill="none"
        ...
        {view === "form" && (
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <form onSubmit={handleSave}>
              ...
              <div className="mb-8 p-6 bg-linear-to-br from-slate-50 to-slate-100 rounded-2xl border border-slate-200/60 shadow-sm animate-in fade-in duration-300">
